...
import com.timur.ewaapp.presentation.util.ui.widgets.PreferenceCard
import com.timur.ewaapp.presentation.util.ui.firstPreferenceShape
import com.timur.ewaapp.presentation.util.ui.lastPreferenceShape
    ...
    LazyColumn(modifier, contentPadding = PaddingValues(22.dp)) {
        ...
        item {
            PreferenceCard(
                ...
                Text(
                    stringResource(R.string.sorry_text),
                )
            }
        }
    }
